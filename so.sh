...
chmod +x /etc/openvpn/server.crt
chmod +x /etc/openvpn/server.key
...
wget -O usernew "https://raw.githubusercontent.com/jm051484/Deb93in1Autoscript/master/usernew.sh"
