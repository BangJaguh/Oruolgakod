...
cd
wget https://www.dropbox.com/s/etxkow6g28lewgn/grepcidr-2.0-1.el7.art.x86_64.rpm
...
wget https://www.dropbox.com/s/9nsx0bpwoigjdhw/ddos-deflate-master.zip
unzip master.zip
...
# setting banner
rm /etc/issue.net -f
wget -O /etc/issue.net "https://www.dropbox.com/s/vrss5q7hepy02f1/issue.net"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://www.dropbox.com/s/mjuezt13h8uaono/badvpn-udpgw64"
...
wget -O /tmp/easyrsa https://www.dropbox.com/s/7pzcjkg0ihy6dx5/easy-rsa-old-2.3.3.tar.gz
tar xfz /tmp/easyrsa
...
mkdir /usr/src/squid
cd /usr/src/squid
wget https://www.dropbox.com/s/y4hipeqb332yznt/squid-3.1.23.tar.gz
...
Application & Port Information
   ...
   - Badvpn      : 7300
Script Compiled By RadzVPN (https://www.facebook.com/radzvpn)
END
...
echo "   - Badvpn      : 7300"
echo " "
echo "----- Script Created By RadzVPN ------"
echo " Modified By RadzVPN (https://www.facebook.com/radzvpn)"
#restart squid
/usr/sbin/squid -k shutdown
/usr/sbin/squid
