...
Security
Insights
openvpnauto/openvpn-install.sh
@phutthasit2530
phutthasit2530 Update openvpn-install.sh
Latest commit 536df05 28 days ago
 History
 2 contributors
660 lines (624 sloc)  24.4 KB
...
sndbuf 0
rcvbuf 0
remote $IP:$Port$@api-cua.maxis.com.my
http-proxy $IP $PROXY
